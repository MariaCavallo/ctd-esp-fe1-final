...
## DEMO del proyecto:
[https://examen-final-esp-front.vercel.app/](https://examen-final-esp-front.vercel.app/)

## Indice
- [ctd-esp-fe1-final](#ctd-esp-fe1-final)
  ...
  - [Guía para comenzar](#guía-para-comenzar)
    ...
    - [Paso 2 - Configuración de Saga](#paso-2---configuración-de-saga)
    - [Paso 3 - Tipado de los componentes existentes](#paso-3---tipado-de-los-componentes-existentes)
    - [Paso 4 - Modelado](#paso-4---modelado)
    - [Paso 5 - Creación del estado y el/los reducer](#paso-5---creación-del-estado-y-ellos-reducer)
    - [Paso 6 - Armado de la UI](#paso-6---armado-de-la-ui)
    - [Paso 7 - Integración](#paso-7---integración)
